...
// core components
import componentStyles from "assets/theme/components/cards/sortable/card-dark-table-sortable.js";
...
export default function CardDarkTableSortable() {
  const classes = useStyles();
  ...
  return (
    <>
      <Card classes={{ root: classes.cardRoot + " " + classes.cardRootDark }}>
        <CardHeader
